...
log('zombie', 1, 2) // zombie [1, 2]
log('zombie', 1, 2, 3) // zombie [1, 2, 3]
```
...
// 字符串会以字符数组的形式做合并
Object.assign({}, 'zombie') // {0: 'm', 1: 'a', 2: 'o', 3: 'm', 4: 'a', 5: 'o'}
...
```js
const obj = { name: 'zombie', age: 18 }
Object.keys(obj) // ['name', 'age']
Object.values(obj) //  ['zombie', 18]
Object.entries(obj) // [['name', 'zombie'], ['age', 18]]
```
...
```js
Object.fromEntries([['name', 'zombie']]) // {name: 'zombie'}

/* Map 转对象 */
const map = new Map([['name', 'zombie']])
Object.fromEntries(map) // {name: 'zombie'}

/* 将查询字符串转为对象 */
const params = 'name=zombie&age=18'
Object.fromEntries(new URLSearchParams(params)) // {name: 'zombie', age: '18'}
```
...
[Promise 实现](https://github.com/zombiezjzj/Promise) 简易实现、A+ 规范实现、原型方法、静态方法实现
