...
// 对象实例
const person1 = new Person('zombie')
console.log(person1) // Person {name: 'zombie'}
```
...
console.log(person1.name, person2.name) // 'zombie' 'zombie'
```
...
// 对象实例
const person = new Person('zombie')
