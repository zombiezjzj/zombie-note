...
GitHubPages完整阅读：[进入](https://hollischuang.github.io/toBeTopJavaer/)

GiteePages完整阅读：[进入](http://hollischuang.gitee.io/tobetopjavaer)(国内访问速度较快)
...
* [JDK6和JDK7中substring的原理及区别](basics/java-basic/substring.md)
...
* [Java8中的StringJoiner](basics/java-basic/stringjoiner-in-java8.md)
...
* [Java8中stream相关用法](basics/java-basic/stream.md)
...
* [fail-fast和fail-safe](basics/java-basic/fail-fast-vs-fail-safe.md)
...
* [Linux5种IO模型](basics/java-basic/linux-io.md)
...
* [反射与工厂模式实现SpringIOC](basics/java-basic/ioc-implement-with-factory-and-reflection.md)
...
* [Serializable和Externalizable有何不同](basics/java-basic/diff-serializable-vs-externalizable.md)
...
* [泛型中KTVE？object等的含义](basics/java-basic/k-t-v-e.md)

* 泛型各种用法

* [限定通配符和非限定通配符](basics/java-basic/Wildcard-Character.md)

* [上下界限定符extends和super](basics/java-basic/extends-vs-super.md)
...
* [Java8中的时间处理](basics/java-basic/time-in-java8.md)
...
* [BigEndian和LittleEndian](basics/java-basic/big-endian-vs-little-endian.md)
...
* [StreamAPI](basics/java-basic/stream.md)
...
* [模块化（jbossmodules、osgi、jigsaw）](basement/jvm/moduler.md)
...
* 公共DNS：114DNS、GoogleDNS、OpenDNS
...
* 负载均衡：Feign、SpringCloudLoadbalance
...
* IntellijIDEA
* 常用插件：MavenHelper、FindBugs-IDEA、阿里巴巴代码规约检测、GsonFormat、Lombokplugin、.ignore、Mybatisplugin
...
* 使用Arthas快速排查SpringBoot应用404/401问题

* 使用Arthas排查线上应用日志打满问题

* 利用Arthas排查SpringBoot应用NoSuchMethodError
